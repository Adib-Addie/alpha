      ...
      child: MouseRegion(
        ...
        child: GestureDetector(
          ...
          child: Container(
            padding: const EdgeInsets.all(16),
            decoration: BoxDecoration(
              color: isHidden ? AppTheme.backgroundMid.withOpacity(0.5) : AppTheme.backgroundMid.withOpacity(0.9),
              borderRadius: BorderRadius.circular(16),
              border: Border.all(
                color: isHidden ? AppTheme.divider.withOpacity(0.1) : AppTheme.border.withOpacity(0.5),
                width: 1.5,
              ),
              boxShadow: [
                BoxShadow(
                          ...
                          Semantics(
                            ...
                            child: IconButton(
                              icon: Icon(
                                ...
                                color: isHidden ? AppTheme.textSecondary : const Color(0xFF7B2FBE),
                                size: 20,
                              ),
...
class AnimatedQuestionDialog extends StatelessWidget {
  final Map<String, dynamic> data;
  final String date;
  final String questionId;
                ...
                TextButton(
                  ...
                  child: Text(
                    ...
                    style: GoogleFonts.inter(
                      fontSize: 14,
                      fontWeight: FontWeight.w600,
                      color: isHidden ? const Color(0xFF7B2FBE) : const Color(0xFFFFB300),
                    ),
                  ),
                ),
                const SizedBox(width: 8),
