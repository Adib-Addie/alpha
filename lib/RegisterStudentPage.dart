        ...
        child: Column(
          ...
          children: [
            ...
            ModernButton(
              ...
              gradient: const [AppTheme.backgroundStart, AppTheme.backgroundMid, AppTheme.backgroundEnd],
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        prefixIcon: Icon(
          widget.icon,
          color: _isFocused ? const Color(0xFF6677EA) : AppTheme.textSecondary,
        ),
        suffixIcon: widget.suffixIcon,
        filled: true,
        fillColor: AppTheme.backgroundMid.withOpacity(0.8),
        border: OutlineInputBorder(
          borderRadius: BorderRadius.circular(16),
          borderSide: BorderSide(color: _isFocused ? const Color(0xFF7B2FBE) : AppTheme.border, width: 1),
        ),
        enabledBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(16),
          borderSide: BorderSide(color: AppTheme.border.withOpacity(0.5), width: 1),
        ),
