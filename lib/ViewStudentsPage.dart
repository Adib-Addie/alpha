  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: AppTheme.backgroundStart.withOpacity(0.4),
              blurRadius: 25,
              offset: const Offset(0, 12),
              spreadRadius: 2,
            ),
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    colors: [
                      ...
                      AppTheme.backgroundEnd.withOpacity(0.5),
                    ],
                    begin: Alignment.topLeft,
                    end: Alignment.bottomRight,
                  ),
              ...
              Container(
                  ...
                  child: LayoutBuilder(
                    builder: (context, constraints) {
                      ...
                      double childAspectRatio = actualCardWidth / 160;
      ...
      body: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [AppTheme.backgroundStart, AppTheme.backgroundMid, AppTheme.backgroundEnd],
          ),
        ),
                ...
                delegate: SliverChildListDelegate([
                  Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        colors: [
                          AppTheme.backgroundStart.withOpacity(0.9),
                      ...
                      boxShadow: [
                        BoxShadow(
                          color: AppTheme.backgroundEnd.withOpacity(0.6),
                          blurRadius: 35,
